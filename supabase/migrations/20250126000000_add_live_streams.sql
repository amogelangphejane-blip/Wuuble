-- Live Streams Migration
-- This migration adds live streaming functionality to communities
...
-- Create stream_viewers table to track who's watching
...
-- Create stream_chat table for live chat during streams
...
-- Create stream_reactions table for live reactions
