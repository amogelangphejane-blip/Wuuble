...
-- Create a periodic job to cleanup inactive calls (this would typically be done via pg_cron or similar)
-- For now, this is just the function definition that can be called manually or via a scheduled job