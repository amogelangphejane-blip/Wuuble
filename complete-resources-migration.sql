-- Complete Resources Migration Script
-- Copy and paste this entire script into Supabase SQL Editor

-- 1. Create resource categories table
...
-- 2. Create community resources table
...
-- 4. Create resource tag assignments table
...
-- 5. Create resource ratings table
...
-- 6. Create resource bookmarks table
...
-- 7. Create resource reports table
...
-- 11. Create RLS policies for resource_categories
CREATE POLICY "Anyone can view categories" 
ON resource_categories FOR SELECT 
USING (true);

-- 12. Create RLS policies for community_resources
...
-- 13. Create RLS policies for resource_tags
...
-- 14. Create RLS policies for resource_tag_assignments
...
-- 15. Create RLS policies for resource_ratings
...
-- 16. Create RLS policies for resource_bookmarks
...
-- 17. Create RLS policies for resource_reports
...
-- Migration complete!
-- The Resources feature should now work on your deployed sites